            ...
            children: [
              ...
              if (_loading)
                ...
                Center(child: Container(
                  ...
                  child: const Icon(Icons.business, color: Colors.blueAccent, size: 36),
                )),
                ...
                Center(child: Text('Fleet Owner', style: TextStyle(color: Colors.blueAccent.withOpacity(0.8), fontSize: 13))),
                const SizedBox(height: 32),
              ...
              const Spacer(),
              // Switch to driver view — only for dev/admin number
